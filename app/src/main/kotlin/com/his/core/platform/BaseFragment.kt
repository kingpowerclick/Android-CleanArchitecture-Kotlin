...
import com.his.R.color
import com.his.core.di.ApplicationComponent
import com.his.core.extension.appContext
import com.his.core.extension.viewContainer
...
abstract class BaseFragment : Fragment() {
	...
	internal fun notifyWithAction(@StringRes message: Int, @StringRes actionText: Int, action: () -> Any) {
		Snackbar.make(viewContainer, message, Snackbar.LENGTH_INDEFINITE)
			.apply {
